...
SELECT "event".*, json_agg(json_build_object('id', "users"."id",'group_name',"users"."name", 'status', "candidate_status"."name")) as groups, json_agg("musical_type"."name") as musical_type FROM "event"
