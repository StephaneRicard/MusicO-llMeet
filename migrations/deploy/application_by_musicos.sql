...
SELECT "users".*, "candidate_status"."name" as status,"candidate_per_event"."id" as application_id,"candidate_per_event"."candidate_status_id" as status_id, json_agg("musical_type"."name") as musical_type FROM "users"
